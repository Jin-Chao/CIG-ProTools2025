...
/*  if(argc == 2){
  ...
  if(varinfo_fname != NULL)
  {
    ...
    varinfo_file_print(getNameWithPostfix(c, 0), &MR((&c), 0, 0, 0, 0), &MR((&c), 0, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(c, 1), &MR((&c), 1, 0, 0, 0), &MR((&c), 1, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(c, 2), &MR((&c), 2, 0, 0, 0), &MR((&c), 2, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(b, 0), &MR((&b), 0, 0, 0, 0), &MR((&b), 0, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(b, 1), &MR((&b), 1, 0, 0, 0), &MR((&b), 1, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(b, 2), &MR((&b), 2, 0, 0, 0), &MR((&b), 2, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(a, 0), &MR((&a), 0, 0, 0, 0), &MR((&a), 0, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(a, 1), &MR((&a), 1, 0, 0, 0), &MR((&a), 1, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(a, 2), &MR((&a), 2, 0, 0, 0), &MR((&a), 2, imax-1, jmax-1, kmax-1));
    varinfo_file_print(getNameWithPostfix(a, 3), &MR((&a), 3, 0, 0, 0), &MR((&a), 3, imax-1, jmax-1, kmax-1));
